...
export const metadata: Metadata = {
  ...
  description:
    "SmartProps is in private beta — build pricing, write polished proposals, and collect e-signatures in one place. Free during the beta with founding-member pricing.",
  openGraph: {
