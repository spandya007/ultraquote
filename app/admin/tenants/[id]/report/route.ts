...
import { getTenantDossier, type TenantDossier, type DossierQuote } from "@/lib/admin/tenant-dossier";
...
export async function GET(_req: Request, { params }: { params: { id: string } }) {
  ...
  return new NextResponse(renderReport(dossier), {
...
function renderReport(d: TenantDossier): string {
  const c = d.counts;
  const f = d.flagged;
